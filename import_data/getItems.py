...
TEST_MODE = False
MAX_ITEMS = 5 if TEST_MODE else 100000  # limite globale pour test ou prod
    ...
    while True:
        ...
        for it in items:
            ...
            if total_items_fetched >= MAX_ITEMS:
                ...
                return  # ou break deux fois pour sortir de la boucle
...
def get_search_post(query: str, limit = 100):
